              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          LayoutBuilder(
                            builder: (context, constraints) {
                              ...
                              final size = width * (isMobile ? 0.18 : 0.2);
                              return AppLogo(width: size, height: size);
                            },
                          ),
                          const Gap(20),
                          Text(
                            t.noda.intro.headline,
                            textAlign: TextAlign.center,
                            style: theme.textTheme.headlineMedium,
                          ),
                          const Gap(10),
                          Text(
                            t.noda.intro.subheadline,
                    ...
                    ).animate().fadeIn(duration: 320.ms, delay: 90.ms).slideY(begin: .05, end: 0),
                    const Gap(20),
                    Focus(
                    ...
                    ).animate().fadeIn(duration: 280.ms, delay: 170.ms),
                    Focus(
          ...
          child: Align(
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints(
                maxWidth: isMobile ? double.infinity : (isApple ? 340 : 300),
                minWidth: isMobile ? double.infinity : 260,
              ),
              child: NodaPanel(
                radius: isMobile ? 24 : 22,
                ...
                child: FilledButton.icon(
                  ...
                  style: FilledButton.styleFrom(
                    padding: EdgeInsets.symmetric(horizontal: isMobile ? 20 : 18, vertical: isMobile ? 18 : 16),
                  ),
                ),
              ),
            ),
